...
fn test_constants_values() {
    ...
    assert_eq!(constants::COOKIE_NAME, "centaurai-session");
    assert_eq!(constants::LEGACY_COOKIE_NAME, "aionui-session");
    assert_eq!(constants::CSRF_COOKIE_NAME, "centaurai-csrf-token");
    assert_eq!(constants::LEGACY_CSRF_COOKIE_NAME, "aionui-csrf-token");
