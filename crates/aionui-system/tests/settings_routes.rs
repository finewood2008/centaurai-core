...
use aionui_system::{
    ...
    ProviderService, RuntimePrepareService, SettingsService, SystemRouterState, VersionCheckService, settings_routes,
};
...
async fn setup() -> (axum::Router, aionui_db::Database) {
    ...
    (
        settings_routes(state).layer(axum::Extension(aionui_auth::CurrentUser {
