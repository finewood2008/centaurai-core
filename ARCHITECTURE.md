...
CentaurAI Core is the backend server for CentaurAI, built with Rust (Axum + Tokio + SQLite).
It provides HTTP REST APIs and WebSocket real-time events for CentaurAI clients.
